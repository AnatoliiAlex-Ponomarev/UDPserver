...
class PacketHandlerTest {
    ...
    void makeInstance() {
        ...
        byte [] buffZeroToSeven = {0,1,2,3,4,5,6,7};
        double checkDouble = ByteBuffer.wrap(buffZeroToSeven).getDouble();

        PacketData pdActual = new PacketData(new short[]{0, 1, 2, 3, 4, 5},
            (byte) 1, 66051L, 283686952306183L, checkDouble, checkDouble);
            //283686952306183L, 283686952306183L);
        assertNotNull(pd);
